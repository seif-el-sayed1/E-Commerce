...
export const Sidebar = () => {
    ...
    return (
        <div>
            <div className={` absolute md:relative w-1/2 md:w-[250px] md:top-0 md:left-0 border-gray-500 bg-[#263238] h-screen ${open ? 'top-0 left-0' : '-left-full'} transition-all duration-300`}>
                ...
                <div>
                    ...
                    <Link to="/add-product" className='flex items-center gap-4  hover:bg-[#1E88E5] p-2 rounded duration-300'>
                    ...
                    <Link to="/list-products" className='flex items-center gap-4  hover:bg-[#1E88E5] p-2 rounded duration-300'>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-5 text-white">
                    ...
                    <Link to="/users" className='flex items-center gap-4  hover:bg-[#1E88E5] p-2 rounded duration-300'>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-5 text-white">
                    ...
                    <Link to="/all-orders" className=' flex items-center gap-4  hover:bg-[#1E88E5] p-2 rounded duration-300'>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-5 text-white">
