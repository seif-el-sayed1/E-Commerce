    ...
    return (
        <div className="mx-6 md:mx-16 lg:mx-24 xl:mx-32 my-10 ">
            ...
            <div className="flex justify-center mt-10">
                <Link to={"/products"} onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })} className="cursor-pointer px-8 py-1.5 rounded border border-[#1E88E5] text-[#1E88E5] hover:bg-[#1E88E5] hover:text-white transition duration-300 text-sm">
                    See More
                </Link>
            </div>
        </div>
